...
function assocArr(array1, array2){
    var assocObj = {};
    for(var index =0; index < array1.length; index++){
        assocObj[array1[index]] = array2[index];
    }
    return assocObj;
}
console.log(assocArr(["abc", 3, "yo"],[42, "wassup", true]))
...
function numValues(obj){
  ...
  console.log(numValues({band: "Travis Shredd & the Good Ol’ Homeboys", style: "Country/Metal/Rap", album: "668: The Neighbor of the Beast"}))
